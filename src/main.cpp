...
uint256 hashGenesisBlock("0x00000c419e8ff64e4edef70a377c710945609a5f721615682d10c3874b1e48d8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FeatherCoinClassic: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FeatherCoinClassic Signed Message:\n";
...
static const int64 nTargetTimespan = 2.5 * 60;	// FeatherCoinClassic: 2.5 mins 
static const int64 nTargetSpacing = 60;			// FeatherCoinClassic: 30 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal feathercoinclassic miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FeatherCoinClassic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000c419e8ff64e4edef70a377c710945609a5f721615682d10c3874b1e48d8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In February 24, 2014, A 4.4 billion-year-old Crystal is discovered to be the oldest known fragment from the earth's crust. 1424729911.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x6d8536120356166e6b22ed029626e776c27c86d6ddca4d21a8f9022ee6c4cd03"));
